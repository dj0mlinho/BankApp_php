...
<head>
  ...
  <title><?php echo "Edit/Delete Account - $username" ?></title>
            ...
            <thead>
              <tr>
                ...
                <tr>
                  ...
                  <td><a href="deleteAccount.php?id=<?php echo $value['id'] ?>" class="btn btn-danger btn-sm">Delete</a></td>
                  <td><a href="editAccount.view.php?id=<?php echo $value['id'] ?>" class="btn btn-warning btn-sm">Edit</a></td>
                </tr>
                <?php endforeach?> 
          </table>
        </div>
